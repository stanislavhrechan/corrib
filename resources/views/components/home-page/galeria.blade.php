...
<div class="flex flex-col md:flex-row justify-center items-center overflow-hidden w-full py-6 md:mb-10 gap-10">
    <div class="">
        ...
        <a href="" class="relative group block mx-5">
...
<div class="flex flex-col justify-center items-center mt-10 md:mt-0 mb-20">
    <a href="" class="bg-black hover:bg-white text-gray-100 hover:text-black uppercase  px-6 py-2  transition cursor-pointer duration-300  text-sm tracking-[0.1em]">
        Otvoriť galériu
    </a>
</div>
